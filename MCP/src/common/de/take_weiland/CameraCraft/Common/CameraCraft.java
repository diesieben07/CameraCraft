...
@Mod(modid = "CameraCraft", version = "2.2.1", name = "CameraCraft")
@NetworkMod(versionBounds = "[2.2,2.2.1]", channels = { "CameraCraft" }, packetHandler = PacketHandler.class, connectionHandler = ConnectionHandler.class, clientSideRequired = true, serverSideRequired = false)
